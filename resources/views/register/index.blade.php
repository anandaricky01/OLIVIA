...
<html lang="en">
  ...
  <body class="fluid" onload="myFunction()">
    <div id="loading"></div>
    <div class="container daftar mt-4">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 col-12 kiri">
              ...
              <img src="/img/daftar/daftar.jpg" class="img-fluid gambar" alt="" />
          </div>
            ...
            <form class="border border-info p-3 shadow" style="border-radius: 30px;" action="/register" method="POST">
              ...
              <div class="container">
                <div class="mb-3">
                  ...
                  <input type="name" class="form-control @error('name') is-invalid @enderror" id="exampleInputName" aria-describedby="namelHelp" name="name" required value="{{ old('name') }}">
                  @error('name')
                ...
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail" aria-describedby="emailHelp" name="email" required value="{{ old('email') }}">
                  @error('email')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control @error('email') is-invalid @enderror" id="exampleInputPassword1" name="password" required>
                  @error('password')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
